...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 rounded-full border-2 hidden md:block xl:hidden",
        orientation === "horizontal"
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 border-2 rounded-full hidden md:block xl:hidden",
        orientation === "horizontal"
...
const CarouselDots: React.FC = () => {
  ...
  return (
    <div className="embla__dots flex items-center justify-center">
