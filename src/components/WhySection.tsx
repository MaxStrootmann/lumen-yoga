      ...
      <div id="logo-and-text" className="pb-4">
        ...
        <div className="pt-4">
          ...
          <p className="px-4 pt-4">
            ...
            groot en het lesprogramma is te gestandaardiseerd. Het gevolg is dat
            kinderen en leerkrachten gefrustreerd raken. Wereldwijd
        ...
        <div className="pt-4">
          <h2 className="px-4 pt-4 text-4xl font-bold">De Nieuwe Yogaschool</h2>
          <p className="px-4 pt-4">
            ...
            en mindfulness. De lessen bestaan uit oefeningen waarmee kinderen op
            een speelse manier leren om bewust te focussen en taken met aandacht
            uit te voeren. Daarnaast ontdekken ze dat er in jezelf altijd een
            stille plek is waar je naartoe kunt gaan. Wanneer je druk bent in je
            hoofd, als je je niet fijn voelt of als je iets spannend vindt.
          </p>
          <p className="px-4 pt-4">
